...
const Login = () => {
  ...
  useEffect(() => {
    setIsFormFilled(formData.email !== '' && formData.password !== '');
  }, [formData]);
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg relative overflow-hidden transform hover:scale-105 transition-all duration-300 ease-in-out">
        ...
        <div className="relative">
          <div className="flex flex-col items-center">
            ...
            <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900 animate-fadeIn">Welcome Back</h2>
            <p className="mt-2 text-center text-sm text-gray-600 animate-fadeIn animation-delay-300">Sign in to your account</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <Link to="/signup" className="font-medium text-[#34a5b1] hover:text-[#2c8d98] transition-colors duration-300">
